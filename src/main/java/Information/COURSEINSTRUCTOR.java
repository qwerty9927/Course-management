...
public class COURSEINSTRUCTOR extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tieude.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI/image/online-education.png"))); // NOI18N
        tieude.setText(" COURSE INSTRUCTION");
        getContentPane().add(tieude, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 20, 285, -1));
        ...
        getContentPane().add(Lastname, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 130, 176, 20));

        Firstname.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        Firstname.setText(" Person ID:");
        getContentPane().add(Firstname, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 190, -1, 30));
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Course ID", "Title", "Person ID", "Firist Name", "Last Name"
            }
        ));
        ...
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 130, 370, 30));

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        getContentPane().add(jComboBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 190, 370, 30));

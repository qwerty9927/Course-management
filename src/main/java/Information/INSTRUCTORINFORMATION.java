 ...
 * @author MSIs
 */
public class INSTRUCTORINFORMATION extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tieude.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI/image/teacher (2).png"))); // NOI18N
        tieude.setText(" INSTRUCTION INFORMATION");
        getContentPane().add(tieude, new org.netbeans.lib.awtextra.AbsoluteConstraints(285, 20, 300, -1));

        Lastname.setBackground(new java.awt.Color(0, 153, 255));
        Lastname.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        Lastname.setText("Last name:");
        getContentPane().add(Lastname, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 110, 176, 20));

        Firstname.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        Firstname.setText("First name:");
        getContentPane().add(Firstname, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 150, -1, 20));

        Enrollmentdate.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        Enrollmentdate.setText("Hire Date:");
        getContentPane().add(Enrollmentdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 190, 160, 20));
        ...
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 150, 310, -1));
        ...
        getContentPane().add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 190, 310, -1));
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "InstructoID", "Last name", "First name", "Hire Date"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(INSTRUCTORINFORMATION.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new INSTRUCTORINFORMATION().setVisible(true);
            }
        });
    }
